(function(){
  angular
    ...
    function verProyectoController(verProyectoService,ImagenService,Upload,$scope, proyectosService){ //se inyecta el service userService en el controlador para que se tenga acceso
      //controlador
